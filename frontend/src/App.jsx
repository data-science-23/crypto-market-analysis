...
import { LineChart, Newspaper, Activity, MessageCircle } from "lucide-react";
      ...
      <nav className="w-20 bg-slate-950 flex flex-col items-center py-6 border-r border-slate-800 z-10">
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <button
            ...
            className={`p-3 mx-auto rounded-xl transition-all ${activeTab === "chatbot" ? "bg-slate-800 text-yellow-400" : "text-slate-500 hover:text-slate-300"}`}
            title="AI Assistant"
          >
